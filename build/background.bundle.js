...
chrome.runtime.onInstalled.addListener(async () => {
  ...
  function onGot(e) {
    // console.log(e)
    if (e.data == undefined) chrome.storage.local.set({
...
function save(json) {
  ...
  if (json['tags']) {
    data.properties['tags'] = {
      multi_select: Array.from(json['tags'], t => ({
        name: t
      }))
    };
  }
...
chrome.runtime.onMessage.addListener(async function (request, sender, sendResponse) {
  ...
  if (request.cmd == 'mark-result') {
    ...
    queryNotEmptyOfReply(request.timestamp).then(res => {
      ...
      getAllTags().then(tRes => {
        ...
        chrome.storage.local.get('tags').then(({
          tags
        }, _) => {
  ...
  } else if (request.cmd =  true && isOpenLogin == false) {
    chrome.tabs.create({
      url: 'newtab.html'
    });
    isOpenLogin = true;
...
(function () {
  ...
  reactHotLoader.register(cfxAddress, "cfxAddress", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(isOpenLogin, "isOpenLogin", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(token, "token", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(databaseId, "databaseId", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(fetchRequest, "fetchRequest", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(postData, "postData", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(save, "save", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(queryByPageId, "queryByPageId", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(queryByTag, "queryByTag", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(getAllTags, "getAllTags", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(findByTag, "findByTag", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(getTimestamp, "getTimestamp", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(queryNotEmptyOfReply, "queryNotEmptyOfReply", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
  reactHotLoader.register(parseData, "parseData", "/Users/shadow/Documents/shadow/Knowledge/src/pages/Background/index.js");
})();
;
(function () {
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("d4da84ede662f5e4635a")
/******/ 	})();
/******/ 	
